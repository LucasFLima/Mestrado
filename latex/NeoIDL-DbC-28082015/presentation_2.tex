...
\titlespacing{\subsection}{0mm}{-1mm}{-1mm} % Lengths are: left, before, after
...
\newcommand*{\mytitle}{NeoIDL - DbC Syntax} % Title
\newcommand*{\runninghead}{DbC Syntax} % Running head displayed on almost all slides
\newcommand*{\myauthor}{Lucas F. Lima / Rodrigo Bonifácio} % Presenters name(s)
\newcommand*{\mydate}{\today} % Presentation date
\newcommand*{\myuni}{Universidade de Brasília - Departamento de Ciência da Computação/Faculdade de Tecnologia} % University or department
