...
% 	NeoIDL DBC - Exemplo
% 	Desenho da Solução:
% 		Poderia ser anotação
% 		Opção por alterar a sintaxe
% 		Análise de Eiffel, JML, Spec #
% 		Citar parte da BNF
% 		Apresentar a mecânica (figuras)
% 	Implementação
% 		Twisted		
