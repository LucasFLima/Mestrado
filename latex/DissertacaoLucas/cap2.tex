...
\begin{figure}[h]
\begin{small}
\lstinputlisting[language=Eiffel,firstnumber=1]{exemploEiffel.tex}
\vspace{-.5cm}
\end{small}
...
\begin{figure}[h]
\begin{small}
\lstinputlisting[language=JML,firstnumber=1]{exemploJML.tex}
\vspace{-.5cm}
\end{small}
...
\begin{figure}[h]
\begin{small}
\lstinputlisting[language=SpecSharp,firstnumber=1]{exemploSpecSharp.tex}
\vspace{-.5cm}
\end{small}
