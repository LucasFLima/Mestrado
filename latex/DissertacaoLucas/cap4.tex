...
duas seções: a declaração das condições de \designbycontract{} e o carregamento
dessas condições. A Figura \ref{lst:filtrosServicosTwisted} contém um trecho da
classe \emph{ServiceFilter}. Na linha 10, as precondições são carregadas. O
acionamento do serviço principal está na linha 13. Por fim, as pós-condições são
carregadas na linha 16.
...
A seção de condições \designbycontract{} contém a lista de pré e pos-condições
do serviço. 
