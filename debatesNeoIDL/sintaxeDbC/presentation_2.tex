...
\newcommand*{\mytitle}{Sintaxe NeoIDL para notação DbC} % Title
\newcommand*{\runninghead}{Sintaxe DbC} % Running head displayed on almost all slides
\newcommand*{\myauthor}{Lucas F. Lima} % Presenters name(s)
\newcommand*{\mydate}{\today} % Presentation date
\newcommand*{\myuni}{Universidade de Brasília --- Faculdade de Tecnologia} % University or department
...
\subsection{Exemplo do Código}

\begin{lstlisting}[language=NeoIDL, caption=Python example]
